...
public class PataConectoraOld {
	 ...
	 */
	public static PataConectoraOld create(final Long idLocal, final Nodo nodoRemoto) {
		final PataConectoraOld pata = new PataConectoraOld();
