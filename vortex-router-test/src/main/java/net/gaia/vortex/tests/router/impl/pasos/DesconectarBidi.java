...
/**
 * Este paso representa la desconexion bidireccional de dos nodos
 * 
 * @author D. García
 */
public class DesconectarBidi extends PasoSupport {
	...
	public void ejecutar() {
		getNodoDestino().quitarDestino(getNodoLocal());
		getNodoLocal().quitarDestino(getNodoDestino());
	}
	...
	public static DesconectarBidi create(final Nodo origen, final Nodo destino) {
