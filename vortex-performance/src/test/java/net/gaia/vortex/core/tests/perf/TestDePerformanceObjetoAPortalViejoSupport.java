 ...
 * @author D. García
 */
public abstract class TestDePerformanceObjetoAPortalViejoSupport {
	 ...
	 */
	protected abstract PortalViejo crearPortalATestear();
	...
	private void testearParaThreads(final int cantidadDeThreads) throws InterruptedException {
		final PortalViejo flujo = crearPortalATestear();
	 ...
	 *             Si vuela todo
	 */
	private void testearFlujo(final int cantidadDeThreadsDeEnvio, final PortalViejo flujo) throws InterruptedException {
		final PortalViejo entrada = flujo;
		...
		entrada.conectarCon(new ReceptorSupport() {
	...
	private void correrThreadsEmisores(final int cantidadDeThreadsDeEnvio, final String nombreDelTest,
			final MetricasPorTiempoImpl metricas, final PortalViejo nodoVortex) throws InterruptedException {
