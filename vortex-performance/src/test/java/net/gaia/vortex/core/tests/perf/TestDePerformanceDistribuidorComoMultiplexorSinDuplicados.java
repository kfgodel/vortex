/**
 * Created on: Sep 21, 2013 2:11:19 PM by: Dario L. Garcia
 * 
...
/**
 * Esta clase prueba la performance de procesamiendo de mensajes de un distribuidor de mensajes sin
 * duplicados usado como multiplexor
 * 
 * @author dgarcia
 */
public class TestDePerformanceDistribuidorComoMultiplexorSinDuplicados extends TestDePerformanceNodoSupport {
