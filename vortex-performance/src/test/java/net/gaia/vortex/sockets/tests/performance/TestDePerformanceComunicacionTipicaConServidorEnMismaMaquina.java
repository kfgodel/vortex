...
public class TestDePerformanceComunicacionTipicaConServidorEnMismaMaquina extends TestDeComunicacionTipicaSupport {

	@Before
	public void crearProcesador() {
		final InetSocketAddress sharedAddress = new InetSocketAddress(61616);
