 ...
 * {@link java.util.Random} generator used by the {@link java.lang.Math} class, a
 * {@code ThreadLocalRandom} is initialized with an internally generated seed that may not otherwise
 * be modified. When applicable, use of {@code ThreadLocalRandom} rather than shared {@code Random}
...
public class ThreadLocalRandom extends Random {
	 ...
	 * constructor. We can't allow others since it would cause setting seed in one part of a program
	 * to unintentionally impact other usages by the thread.
	 */
	boolean initialized;
