...
import net.gaia.vortex.lowlevel.impl.ids.IdentificadorDeEmisorAleatorio;
import net.gaia.vortex.lowlevel.impl.ids.SecuenciadorCompartible;
import net.gaia.vortex.lowlevel.impl.ids.SecuenciadorMensajes;
import net.gaia.vortex.lowlevel.impl.ids.StringHasher;
import net.gaia.vortex.lowlevel.impl.ids.SystemMillisStamper;
import net.gaia.vortex.lowlevel.impl.ids.TimeStamper;
...
public class GeneradorDeMensajesImpl implements GeneradorMensajesDeNodo {
	...
	/**
	 * @see net.gaia.vortex.lowlevel.impl.GeneradorMensajesDeNodo#generarMensajePara(java.lang.Object,
	 *      java.lang.String[])
	 */
	@Override
