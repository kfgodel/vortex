/**
 * 16/01/2012 20:08:29 Copyright (C) 2011 Darío L. García
 * 
...
public class RecibirLimpiarTagsWorkUnit implements WorkUnit {
	...
	public static RecibirLimpiarTagsWorkUnit create(final ContextoDeRuteoDeMensaje contexto) {
		final RecibirLimpiarTagsWorkUnit agregar = new RecibirLimpiarTagsWorkUnit();
