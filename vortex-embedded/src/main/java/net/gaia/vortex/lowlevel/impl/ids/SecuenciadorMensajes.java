...
/**
 * Esta interfaz define los métodos necesarios para asignar número de secuencia a los mensajes
 * 
 * @author D. García
 */
public interface SecuenciadorMensajes {
	...
	/**
	 * Devuelve el número de secuencia próximo disponible, incrementando el siguiente
	 * 
