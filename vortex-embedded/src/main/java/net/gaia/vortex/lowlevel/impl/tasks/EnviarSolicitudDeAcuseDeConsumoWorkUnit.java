 ...
 * @author D. García
 */
public class EnviarSolicitudDeAcuseDeConsumoWorkUnit implements TareaParaReceptor {
	...
	public boolean esPara(final ReceptorVortex receptor) {
		final IdentificadorDeEnvio idDeEnvio = contexto.getIdDeEnvio();
		final ReceptorVortex receptorDestino = idDeEnvio.getReceptorDestino();
		return receptorDestino == receptor;
	}
