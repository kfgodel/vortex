...
public class MemoriaDeMensajesImpl implements MemoriaDeMensajes {
	...
	/**
	 * @see net.gaia.vortex.lowlevel.impl.mensajes.MemoriaDeMensajes#registrarSiNoRecuerdaA(net.gaia.vortex.protocol.messages.MensajeVortex)
	 */
	@Override
	...
	/**
	 * @see net.gaia.vortex.lowlevel.impl.mensajes.MemoriaDeMensajes#getEsperandoAcuseDeConsumo()
	 */
	@Override
