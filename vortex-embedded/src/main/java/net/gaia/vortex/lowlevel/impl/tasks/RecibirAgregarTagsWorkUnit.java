/**
 * 15/01/2012 20:52:28 Copyright (C) 2011 Darío L. García
 * 
 ...
 * @author D. García
 */
public class RecibirAgregarTagsWorkUnit implements TareaParaReceptor {
	...
	public static RecibirAgregarTagsWorkUnit create(final ContextoDeRuteoDeMensaje contexto, final AgregarTags mensaje) {
		final RecibirAgregarTagsWorkUnit agregar = new RecibirAgregarTagsWorkUnit();
