...
public class MemoriaDeRuteosImpl implements MemoriaDeRuteos {
	...
	/**
	 * @see net.gaia.vortex.lowlevel.impl.MemoriaDeRuteos#registrarRuteoTerminado(net.gaia.vortex.lowlevel.impl.IdentificadorDeEnvio)
	 */
	@Override
	...
	/**
	 * @see net.gaia.vortex.lowlevel.impl.MemoriaDeRuteos#tieneRuteoActivoPara(net.gaia.vortex.lowlevel.impl.IdentificadorDeEnvio)
	 */
	@Override
	...
	/**
	 * @see net.gaia.vortex.lowlevel.impl.MemoriaDeRuteos#eliminarRuteosActivosPara(net.gaia.vortex.lowlevel.impl.receptores.ReceptorVortex)
	 */
	@Override
