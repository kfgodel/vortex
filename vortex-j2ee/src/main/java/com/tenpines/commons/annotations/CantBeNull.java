 ...
 */
package com.tenpines.commons.annotations;
...
/**
 * Este annotation es utilizado como herramienta de comunicación entre programadores dentro del
 * código para indicar que un valor no debe o no es null<br>
 * <br>
 ...
 * - <b>En el retorno de un método</b>: Indica que el método no retorna null en ningún caso (es
 * null-safe)<br>
 * - <b>En un parámetros</b>: Indica que el método no acepta null como valor posible y se puede
 * producir una excepción inesperada.<br>
 * - <b>En una variable local</b>: No tiene mucho sentido pero se deja abierta la posibilidad de
 * uso, para indicar que no debería ser null en caso de que sea un código complejo.
 * 
 * @author D. García
 */
@Documented
