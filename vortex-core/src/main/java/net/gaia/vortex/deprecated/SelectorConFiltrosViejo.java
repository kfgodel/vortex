...
public class SelectorConFiltrosViejo extends NodoMoleculaSupportViejo implements SelectorViejo {
	...
	/**
	 * @see net.gaia.vortex.deprecated.NodoMoleculaSupportViejo#conectarCon(net.gaia.vortex.api.basic.Receptor)
	 */
	...
	/**
	 * @see net.gaia.vortex.deprecated.SelectorViejo#conectarCon(net.gaia.vortex.api.basic.Receptor,
	...
	/**
	 * @see net.gaia.vortex.deprecated.SelectorViejo#modificarCondicionPara(net.gaia.vortex.api.basic.Receptor,
	 *      net.gaia.vortex.api.condiciones.Condicion)
	 */
	...
	/**
	 * @see net.gaia.vortex.deprecated.NodoMoleculaSupportViejo#desconectarDe(net.gaia.vortex.api.basic.Receptor)
	 */
