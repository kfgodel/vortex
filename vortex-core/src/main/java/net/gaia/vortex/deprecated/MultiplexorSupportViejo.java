...
public abstract class MultiplexorSupportViejo extends ReceptorConProcesador implements MultiplexorViejo {
	...
	/**
	 * @see net.gaia.vortex.deprecated.MultiplexorViejo#conectarCon(net.gaia.vortex.api.basic.Receptor)
	 */
	...
	/**
	 * @see net.gaia.vortex.deprecated.MultiplexorViejo#desconectarDe(net.gaia.vortex.api.basic.Receptor)
	 */
