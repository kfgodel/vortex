...
public class NexoBifurcadorViejo extends ReceptorConProcesador implements BifurcadorViejo {
	...
	/**
	 * @see net.gaia.vortex.deprecated.BifurcadorViejo#setReceptorPorTrue(net.gaia.vortex.api.basic.Receptor)
	 */
	...
	/**
	 * @see net.gaia.vortex.deprecated.BifurcadorViejo#getReceptorPorTrue()
	 */
	...
	/**
	 * @see net.gaia.vortex.deprecated.BifurcadorViejo#setReceptorPorFalse(net.gaia.vortex.api.basic.Receptor)
	 */
	...
	/**
	 * @see net.gaia.vortex.deprecated.BifurcadorViejo#getReceptorPorFalse()
	 */
