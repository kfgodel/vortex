...
public abstract class NexoSupport extends ReceptorConProcesador implements NexoViejo {
	...
	/**
	 * @see net.gaia.vortex.deprecated.NexoViejo#conectarCon(net.gaia.vortex.api.basic.Receptor)
	 */
	 ...
	 * 
	 * @see net.gaia.vortex.deprecated.NexoViejo#desconectarDe(net.gaia.vortex.api.basic.Receptor)
	 */
