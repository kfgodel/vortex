 ...
 */
@Deprecated
public class BifurcarMensajeViejo implements WorkUnit {

	private static final Logger LOG = LoggerFactory.getLogger(BifurcarMensajeViejo.class);
	...
	public void doWork(final WorkParallelizer parallelizer) throws InterruptedThreadException {
		...
		final DelegarMensajeViejo delegacion = DelegarMensajeViejo.create(mensaje, delegadoElegido);
	...
	public static BifurcarMensajeViejo create(final MensajeVortex mensaje, final Condicion condicion,
			final Receptor delegadoPorTrue, final Receptor delegadoPorFalse) {
		final BifurcarMensajeViejo bifurcar = new BifurcarMensajeViejo();
