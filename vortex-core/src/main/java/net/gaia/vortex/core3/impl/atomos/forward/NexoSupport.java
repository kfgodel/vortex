...
public abstract class NexoSupport extends ComponenteConProcesadorSupport implements Nexo {
	...
	/**
	 * @see net.gaia.vortex.core3.api.atomos.forward.Nexo#conectarCon(net.gaia.vortex.core3.api.atomos.Receptor)
	 */
	@Override
	...
	/**
	 * @see net.gaia.vortex.core3.api.atomos.forward.Nexo#desconectarDe(net.gaia.vortex.core3.api.atomos.Receptor)
	 */
	@Override
	...
	/**
	 * @see net.gaia.vortex.core3.api.atomos.forward.Nexo#setDestino(net.gaia.vortex.core3.api.atomos.Receptor)
	 */
	@Override
	...
	/**
	 * @see net.gaia.vortex.core3.api.atomos.forward.Nexo#getDestino()
	 */
	@Override
