...
public class NexoBifurcador extends ComponenteConProcesadorSupport implements Bifurcador {
	...
	/**
	 * @see net.gaia.vortex.core3.api.atomos.condicional.Bifurcador#setReceptorPorTrue(net.gaia.vortex.core3.api.atomos.Receptor)
	 */
	@Override
	...
	/**
	 * @see net.gaia.vortex.core3.api.atomos.condicional.Bifurcador#getReceptorPorTrue()
	 */
	@Override
	...
	/**
	 * @see net.gaia.vortex.core3.api.atomos.condicional.Bifurcador#setReceptorPorFalse(net.gaia.vortex.core3.api.atomos.Receptor)
	 */
	@Override
	...
	/**
	 * @see net.gaia.vortex.core3.api.atomos.condicional.Bifurcador#getReceptorPorFalse()
	 */
	@Override
