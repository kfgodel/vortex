/**
 * Created on: Aug 31, 2013 11:01:38 PM by: Dario L. Garcia
 * 
...
/**
 * Esta interfaz representa un {@link MultiEmisor} al que se le pueden crear conectores desde afuera
 * a través de una interfaz que provee.<br>
 * A través de los métodos de esta interfaz se pueden agregar conectores por los que esta instancia
 * enviará mensajes a otros receptores
 * 
 * @author dgarcia
 */
public interface MultiConectable extends MultiEmisor {
	/**
