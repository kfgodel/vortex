/**
 * 08/07/2013 10:35:27 Copyright (C) 2013 Darío L. García
 * 
 ...
 */
package net.gaia.taskprocessor.perf.impl.tests.sinworkunit;
...
/**
 * Esta clase representa el thread que itera una cantidad de veces en un for y termina
 * 
 * @author D. García
 */
public class ThreadIteradorBrutoPorCantidad extends ThreadBucleSupport {
	...
	private WaitBarrier lineaDeFin;

	public ThreadIteradorBrutoPorCantidad(final int numero) {
		super("<> IteradorBrutoLoop " + numero);
	}
	...
	@Override
	public void run() {
		for (long i = 0; i < cantidadDeVeces; i++) {
	...
	public static ThreadIteradorBrutoPorCantidad create(final long cantidadDeIteraciones, final VariableTicks variable,
		...
		thread.cantidadDeVeces = cantidadDeIteraciones;
