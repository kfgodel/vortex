...
import net.gaia.taskprocessor.perf.impl.tests.processors.ParallelBasedParaLaEjecucion;
...
public class ProcessorPeformanceTester {
	...
	public static void main(final String[] args) {
		...
		final TicksPerSecondTestUnit processorTest = ParallelBasedParaLaEjecucion.create();
