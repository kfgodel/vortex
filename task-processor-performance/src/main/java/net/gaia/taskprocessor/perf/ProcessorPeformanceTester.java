...
import net.gaia.taskprocessor.perf.impl.tests.processors.ForkJoinBasedParaLaEjecucion;
...
public class ProcessorPeformanceTester {
	...
	public static void main(final String[] args) {
		...
		final TicksPerSecondTestUnit processorTest = ForkJoinBasedParaLaEjecucion.create();
