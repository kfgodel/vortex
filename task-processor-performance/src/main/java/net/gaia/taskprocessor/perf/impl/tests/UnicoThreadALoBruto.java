...
public class UnicoThreadALoBruto implements TicksPerSecondTestUnit {
	...
	public String getDescripcion() {
		return "SoloThreadALoBruto = un solo thread con while(true) incrementando la variable directamente (sin el workunit)";
	}
	...
	public void incrementTicksWith(final IncrementarVariableWorkUnit workUnit) {
		...
		threadActivo = ThreadIncrementadorBruto.create(variableTicks);
	}
