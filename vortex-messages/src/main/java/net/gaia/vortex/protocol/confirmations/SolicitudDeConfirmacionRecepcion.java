 ...
 * @author D. García
 */
public class SolicitudDeConfirmacionRecepcion {

	private IdVortex idDeMensajeAConfirmar;

	public static SolicitudDeConfirmacionRecepcion create(final IdVortex mensaje) {
		final SolicitudDeConfirmacionRecepcion solicitud = new SolicitudDeConfirmacionRecepcion();
