...
/**
 * Esta clase indica un error de programación en el que el programador no sabia como manejar una
 * situacion no normal, y la mejor opción fue lanzar esta excepción
 * 
 * @author D. Garcia
 */
public class UnhandledConditionException extends ProgrammerErrorException {
	private static final long serialVersionUID = 1297902026732205907L;

	public UnhandledConditionException(final String message, final Throwable exception) {
	...
	public UnhandledConditionException(final Throwable exception) {
		super(exception);
	}
