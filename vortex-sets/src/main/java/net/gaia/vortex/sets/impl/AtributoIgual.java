...
/**
 * Esta clase representa una condición que evalúa un mensaje vortex según el valor de un atributo.<br>
...
public class AtributoIgual implements Condicion {
	...
	public boolean esCumplidaPor(final MensajeVortex mensaje) {
		...
		final boolean contieneAtributo = contenidoDelMensaje.containsKey(nombreDelAtributo);
		if (!contieneAtributo) {
			return false;
		}
		final Object valorEnElMensaje = contenidoDelMensaje.get(nombreDelAtributo);
		if (valorEsperado == null) {
			final boolean esElValorEsperado = valorEnElMensaje == null;
	...
	public static AtributoIgual create(final String nombreDelAtributo, final Object valorEsperado) {
		final AtributoIgual condicion = new AtributoIgual();
