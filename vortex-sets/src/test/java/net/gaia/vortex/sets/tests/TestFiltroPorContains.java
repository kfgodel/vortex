...
public class TestFiltroPorContains {
	...
	public void deberiaIndicarTrueSiLaPropiedadContieneElValorBuscado() {
		Assert.assertTrue(ContieneAValor.create(PRIMER_TEXTO, COLECCION_FIELD).esCumplidaPor(mensaje));
		Assert.assertTrue(ContieneAValor.create(PRIMER_NUMERO, COLECCION_FIELD).esCumplidaPor(mensaje));
	}

	@Test
	public void deberiaIndicarTrueSiElValorEsperadoEsnullYLaColeccionLoTiene() {
		Assert.assertTrue(ContieneAValor.create(null, COLECCION_FIELD).esCumplidaPor(mensaje));
	}

	@Test
	public void deberiaIndicarFalseSiLaPropiedadNoContieneElValorBuscado() {
		Assert.assertFalse(ContieneAValor.create("Lolololololoooo", COLECCION_FIELD).esCumplidaPor(mensaje));
	}

	@Test
	public void deberiaIndicarFalseSiLaPropiedadNoExiste() {
		Assert.assertFalse(ContieneAValor.create(PRIMER_NUMERO, INEXISTENTE_FIELD).esCumplidaPor(mensaje));
	}

	@Test
	public void deberiaIndicarTrueSiLaPropiedadAnidadaContieneElValor() {
		Assert.assertTrue(ContieneAValor.create(PRIMER_NUMERO, OBJETO_FIELD + "." + COLECCION_FIELD).esCumplidaPor(
				mensaje));
		Assert.assertTrue(ContieneAValor.create(PRIMER_TEXTO, OBJETO_FIELD + "." + COLECCION_FIELD).esCumplidaPor(
				mensaje));
	}

	@Test
	public void deberiaIndicarTrueSiLaPropiedadAnidadaContieneAlNullBuscado() {
		Assert.assertTrue(ContieneAValor.create(null, OBJETO_FIELD + "." + COLECCION_FIELD).esCumplidaPor(mensaje));
	}

	@Test
	public void deberiaIndicarFalseSiLaPropiedadIntermediaEsNull() {
		Assert.assertFalse(ContieneAValor.create(PRIMER_NUMERO, NULL_FIELD + "." + COLECCION_FIELD).esCumplidaPor(
				mensaje));
	}

	@Test
	public void deberiaIndicarFalseSiLaPropiedadIntermediaNoEsUnMapa() {
		Assert.assertFalse(ContieneAValor.create(PRIMER_NUMERO, COLECCION_FIELD + "." + COLECCION_FIELD).esCumplidaPor(
				mensaje));
	}
