...
public class ItemizedGridAdapter<T> extends BaseAdapter {
	 ...
	 */
	public static <T> ItemizedGridAdapter<T> create(Context contexto, RenderBlock<T> elementRenderBlock) {
		ItemizedGridAdapter<T> adapter = new ItemizedGridAdapter<T>();
	 ...
	 */
	public void addItem(T templateItem) {
	 ...
	 */
	public void removeItem(T selectedItem) {
