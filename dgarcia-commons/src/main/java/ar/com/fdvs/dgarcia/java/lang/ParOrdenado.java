 ...
 *
 */
package ar.com.fdvs.dgarcia.java.lang;

import java.util.Map;

import ar.com.fdvs.dgarcia.lang_identificators.EqualsIdentificator;

/**
 * Esta clase implementa la interfaz de Map.Entry brindando
 * la posibilidad de tener un Par de objetos como un objeto en
 * si.
 * Esta clase representa una asociacion de un par de elementos
 * en la cual se establece un orden. Key es el primer elemento
 * y Value el segundo
 * @param <K> Tipo del primer objeto
 * @param <V> Tipo del segundo
 * @version 1.0
 * @since 2006-03-23
 * @author D. Garcia
 */
public class ParOrdenado<K,V> implements Map.Entry<K,V>{
	...
	/**
	 * Constructor basado en los dos
	 * elementos que conforman el par
	 * @param primerElemento primer objeto
	 * @param segundo segundo del par
	 */
	...
	/**
	 * @return Devuelve un array creado con ambos elementos
	 * TODO Cambiar por una variable de tipo cuando se pueda
	 * inferir un supertipo
	 */
	 ...
	 * @param segundo EL nuevo objeto a establecer como segundo
	 * elemento
	...
	/**
	 * Establece el segundo objeto del par
	 * @param value Objeto a contener en este par
