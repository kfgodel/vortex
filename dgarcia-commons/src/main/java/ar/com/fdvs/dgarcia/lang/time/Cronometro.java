 ...
 */
package ar.com.fdvs.dgarcia.lang.time;


/**
 * @author D. Garcia
 *
 * Esta clase permite medir el tiempo con m�todos que ofrecen la
 * funcionalidad de un cronometro.
 * La precision depende de la plataforma pero es ofrecido hasta
 * nanosegundos
 */
public class Cronometro {
	...
	/**
	* Inicializa el cronometro empezando a contar desde el momento
	* de su creacion
	*/
	public Cronometro(){
		this.reset();
	...
	/**
	 * Devuelve la cantidad de milisegundos transcurridos
	 * al momento actual
	...
	/**
	 * Devuelve la cantidad de unidades que marca el reloj actualmente en la
	 * mayor precision de la plataforma
	...
	/**
	 * Pausa el conteo del tiempo hasta que se reanude
	 * la cuenta con start().
	 * Si se llama el tiempo se cuenta por partes, y
	 * debe llamarse a total para saber cuanto es el
	 * total de tiempo
	 * @return El tiempo transcurrido desde
	 * que se inicio la cuenta o desde que se paus�
	 * la ultima vez
	 */
	public long pause(){
	...
	/**
	 * Pone el contador cronometro a cero e
	...
	/**
	 * Marca el milisegundo actual como inicio
	 * del conteo del tiempo, inicia el conteo
	 * del tiempo
	...
	/**
	 * Devuelve la cantidad de milisegundos transcurridos
	 * contabilizados por el cronometro, debe pausarse
	 * para que devuelva el actual
	 * @return El total de tiempo contado (incluyendo las
	 * veces que se detuvo el reloj)
	 */
	public long total(){
		return this.transcurrido;
	}
	 ...
	 *
	 * @param nanos El tiempo en milisegundos
	 * @return El tiempo en segundos
	 */
	public static long asSeconds(long nanos){
		return nanos / (NANOS_PER_MICRO * MICROS_PER_MILI * MILI_PER_SECOND);
	}

	/**
	 * Crea un nuevo cronometro que comienza a contar el
	 * tiempo desde el momento de su creacion
	...
	/**
	 * Genera una cadena formateada para mostrar
	 * tiempos largos
	 * @param cantidad Cantidad de nanosegundos
	 * @return un String con el siguiente formato
	 * "00d 00h:00m:00s.000ms [000us:000ns]". Las magnitudes que
	 * son demasiado grandes para ser registradas
	 * son omitidas
	 */
