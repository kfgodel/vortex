 ...
 */
package ar.com.fdvs.dgarcia.lang.identificators;

import ar.com.fdvs.dgarcia.lang_identificators.AbstractIdentificator;


/**
 * Esta clase toma como dominio conceptual la identidad de los
 * objetos, discriminando y ordenando por su identidad.
 * Para ello se utiliza el metodo nativo {@link java.lang.Object#hashCode()}
...
public class IdentityIdentificator extends AbstractIdentificator<Object> {
	 ...
	 * objeto
	 * @see ar.com.fdvs.dgarcia.lang_identificators.AbstractIdentificator#areEquals(Object, Object)
	 */
	@Override
	 ...
	 * @see ar.com.fdvs.dgarcia.lang_identificators.AbstractIdentificator#discriminator(Object)
	 */
	@Override
