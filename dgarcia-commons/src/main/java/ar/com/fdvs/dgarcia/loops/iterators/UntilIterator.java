 ...
 */
package ar.com.fdvs.dgarcia.loops.iterators;

import java.util.Iterator;

import ar.com.fdvs.dgarcia.lang.closures.Condition;
import ar.com.fdvs.dgarcia.lang.iterators.basic.AbstractIteratorDecorator;
...
public class UntilIterator<T> extends AbstractIteratorDecorator<T> {
	...
	/**
	 * @see ar.com.fdvs.dgarcia.lang.iterators.basic.AbstractIteratorDecorator#hasNext()
	 */
	@Override
	...
	/**
	 * @see ar.com.fdvs.dgarcia.lang.iterators.basic.AbstractIteratorDecorator#next()
	 */
	@Override
	public T next() {
		if(nextElement == null){
