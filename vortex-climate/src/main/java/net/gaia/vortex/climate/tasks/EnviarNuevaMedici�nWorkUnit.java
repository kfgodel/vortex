 ...
 * @author D. García
 */
public class EnviarNuevaMediciónWorkUnit implements WorkUnit {
	private static final Logger LOG = LoggerFactory.getLogger(EnviarNuevaMediciónWorkUnit.class);
	...
	public static EnviarNuevaMediciónWorkUnit create(final ClimateMeasure newMeasure) {
		final EnviarNuevaMediciónWorkUnit envio = new EnviarNuevaMediciónWorkUnit();
